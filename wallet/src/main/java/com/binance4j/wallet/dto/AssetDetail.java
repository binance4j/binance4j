 ...
 * @param depositStatus     Deposit status (false if ALL of networks' are
 *                          false).
 * @param withdrawFee       Withdraw fee.
 * @param withdrawStatus    Withdraw status (false if ALL of networks' are
 *                          false).
...
public record AssetDetail(@ApiModelProperty("Minimal withdraw amount.") String minWithdrawAmount,
		@ApiModelProperty("Deposit status (false if ALL of networks' are false).") boolean depositStatus,
		@ApiModelProperty("Withdraw fee.") Float withdrawFee,
