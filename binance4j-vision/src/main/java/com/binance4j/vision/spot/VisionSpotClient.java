...
public class VisionSpotClient {
	 ...
	 */
	public VisionRequestExecutor<Candle> getKlines(String symbol, CandlestickInterval candlestickInterval,
	 ...
	 * @return The zip file containing the data
	 */
	public VisionRequestExecutor<VisionTrade> getTrades(String symbol, String year, String month)
			throws ApiException {
		if (!isValidDate(year, month))
			throw new InvalidDateException();
	 ...
	 * @return The zip file containing the data
	 */
	public VisionRequestExecutor<VisionTrade> getTrades(String symbol, String year, String month, String day)
			throws ApiException {
		if (!isValidDate(year, month, day))
			throw new InvalidDateException();
