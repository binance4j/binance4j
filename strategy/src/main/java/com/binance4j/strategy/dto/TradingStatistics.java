...
public class TradingStatistics {
	...
	/**
	 * @property tradingRecord Record generated by a backtest.
	 * @property series        Series the record is based on.
	 */
	 ...
	 *
	 * @property initialAmount Initially traded amount.
	 * @property a             A coefficient (e.g. 0.005 for 0.5% per {@link Trade
	 *                      trade}).
	 ...
	 *
	 * @property criterion Criterion to use for calculation.
