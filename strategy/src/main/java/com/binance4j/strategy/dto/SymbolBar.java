...
public class SymbolBar extends BaseBar {
	...
	/**
	 * @property bar        Input bar.
	 * @property isBarFinal Is the bar final?
	 * @property symbol     Bar symbol name.
	 */
	...
	/**
	 * @property isBarFinal IsBarFinal to set
	 */
