...
public class GetAggTradesTests extends MarketTest {
	...
	public void test1() throws ApiException {
		List<AggTrade> res = client.getAggTrades(new AggTradeRequest(symbol)).execute();
		test(res);
	}
	...
	public void test2() throws ApiException {
		List<AggTrade> res = client.getAggTrades(new AggTradeRequest(symbol, limit)).execute();
	...
	public void test3() throws ApiException {
		List<AggTrade> res = client.getAggTrades(new AggTradeRequest(symbol, 1640991600000L, 1640994900000L)).execute();
	...
	public void test4() throws ApiException {
		List<AggTrade> res = client.getAggTrades(new AggTradeRequest(symbol, 244397449L)).execute();
