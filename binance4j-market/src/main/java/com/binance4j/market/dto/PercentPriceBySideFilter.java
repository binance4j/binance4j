...
public record PercentPriceBySideFilter(@ApiModelProperty("Bid multiplier up.") String bidMultiplierUp,
		@ApiModelProperty("Bid multiplier down.") String bidMultiplierDown,
		@ApiModelProperty("Ask multiplier up.") String askMultiplierUp,
		@ApiModelProperty("Ask multiplier down.") String askMultiplierDown,
