 ...
 * @param maxNumAlgoOrders Maximum number of "algo" orders an account is allowed to have open on a symbol. "Algo".
...
public record MaxNumAlgoOrdersFilter(
		 ...
		 */
		@ApiModelProperty("The maximum number of \"algo\" orders an account is allowed to have open on a symbol.") String maxNumAlgoOrders) {
}