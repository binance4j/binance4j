...
public class AllOrdersRequest extends IntervalRequest {
  /**
   * @return The trading pair we want the orders
   * 
   */
  private String symbol;
  /**
   * @return If orderId is set, it will get orders &gt;= that orderId. Otherwise
   *         most
  ...
  /**
   * @return The result size. Default 500; max 1000.
   * 
   */
