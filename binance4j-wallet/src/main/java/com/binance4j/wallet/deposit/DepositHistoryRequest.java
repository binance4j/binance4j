...
public class DepositHistoryRequest extends IntervalRequest {
	 ...
	 */
	public DepositHistoryRequest(String coin, DepositStatus status, int limit) {
		this(coin, status.getValue());
		this.limit = limit;
	}
	 ...
	 * @param limit  The history size. Default:1000, Max:1000
	 */
	public DepositHistoryRequest(String coin, int status, int limit) {
		this(coin, status);
		this.limit = limit;
	}
	 ...
	 */
	public DepositHistoryRequest(String coin, DepositStatus status, int limit, int offset) {
	 ...
	 * @param offset The history offset
	 */
	public DepositHistoryRequest(String coin, int status, int limit, int offset) {
		this(coin, status, limit);
		this.offset = offset;
	}
}