 ...
 * @param withdrawOrderId Withdraw order id. will not be returned if there's no
 *                        withdrawOrderId for this withdraw.
 ...
 * @param status          (0:Email Sent, 1:Cancelled 2:Awaiting Approval
...
public record WithdrawHistory(@ApiModelProperty("Address to withdraw to.") String address,
		@ApiModelProperty("Withdraw date operation.") String applyTime,
		...
		@ApiModelProperty("Network to withdraw on.") String network,
		@ApiModelProperty("Reason for withdrawal failure.") String info,
		...
		@ApiModelProperty("Confirm times for withdraw.") int confirmNo,
		@ApiModelProperty("Withdrawn colume.") String amount,
