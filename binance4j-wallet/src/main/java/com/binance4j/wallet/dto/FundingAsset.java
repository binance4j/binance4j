...
public record FundingAsset(@ApiModelProperty("Asset abbreviation.") String asset, @ApiModelProperty("Available balancve.") String free,
		@ApiModelProperty("Locked balance (volume in the order book).") String locked,
		@ApiModelProperty("Freezed balance. Locked by binance (?)") String freeze, @ApiModelProperty("Pending volume withdrawing.") String withdrawing,
