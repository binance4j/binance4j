...
public record FlexibleProduct(@ApiModelProperty("Asset.") String asset, @ApiModelProperty("Avg annual interest rate.") String avgAnnualInterestRate,
		@ApiModelProperty("Tier annual interest rate.") Map<String, String> tierAnnualInterestRate,
		@ApiModelProperty("Latest annual intarest rate.") String latestAnnualInterestRate, @ApiModelProperty("Product can be purchase?") boolean canPurchase,
		@ApiModelProperty("Product can be redeem?") boolean canRedeem, @ApiModelProperty("Featured.") boolean featured,
		@ApiModelProperty("Min purchase amount.") String minPurchaseAmount, @ApiModelProperty("Product id.") String productId,
