...
<Tabs>
    ...
    <TabItem label="Multiple symbols (List)" value="multiple-symbols-list">
        <CodeBlock language="java">
            WebsocketTickerClient client = new WebsocketTickerClient(Arrays.asList("BNBBTC", "BNBBUSD"));
        </CodeBlock>
    </TabItem>
</Tabs>
...
<Tabs>
    ...
    <TabItem label="Multiple symbols (List)" value="multiple-symbols-list">
        <CodeBlock language="java">
            WebsocketMiniTickerClient client = new WebsocketMiniTickerClient(Arrays.asList("BNBBTC", "BNBBUSD"));
        </CodeBlock>
    </TabItem>
</Tabs>
...
<Tabs>
    ...
    <TabItem label="Multiple symbols (List)" value="multiple-symbols-list">
        <CodeBlock language="java">
            WebsocketBookTickerClient client = new WebsocketBookTickerClient(Arrays.asList("BNBBTC", "BNBBUSD"));
        </CodeBlock>
    </TabItem>
</Tabs>
...
<Tabs>
    ...
    <TabItem label="Multiple symbols (List)" value="multiple-symbols-list">
        <CodeBlock language="java">
            WebsocketCandlestickClient client = new WebsocketCandlestickClient(Arrays.asList("BNBBTC", "BNBBUSD",
            CandlestickInterval.FIVE_MINUTE));
        </CodeBlock>
    </TabItem>
</Tabs>
...
<Tabs>
    ...
    <TabItem label="Multiple symbols (List)" value="multiple-symbols-list">
        <CodeBlock language="java">
            WebsocketDepthClient client = new WebsocketDepthClient(Arrays.asList("BNBBTC", "BNBBUSD"));
        </CodeBlock>
    </TabItem>
</Tabs>
...
<Tabs>
    ...
    <TabItem label="Multiple symbols (List)" value="multiple-symbols-list">
        <CodeBlock language="java">
            WebsocketMiniDepthClient client = new WebsocketMiniDepthClient(Arrays.asList("BNBBTC", "BNBBUSD"));
        </CodeBlock>
    </TabItem>
</Tabs>
...
<Tabs>
    ...
    <TabItem label="Multiple symbols (List)" value="multiple-symbols-list">
        <CodeBlock language="java">
            WebsocketTradeClient client = new WebsocketTradeClient(Arrays.asList("BNBBTC", "BNBBUSD"));
        </CodeBlock>
    </TabItem>
</Tabs>
...
<Tabs>
    ...
    <TabItem label="Multiple symbols (List)" value="multiple-symbols-list">
        <CodeBlock language="java">
            WebsocketAggTradeClient client = new WebsocketAggTradeClient(Arrays.asList("BNBBTC", "BNBBUSD"));
        </CodeBlock>
    </TabItem>
</Tabs>
