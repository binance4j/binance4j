...
@JsonProperty("spotBNBBurn") var spotBNBBurn:Boolean?=null,
@ApiModelProperty("Is interest BNB burn allowed.") @JsonProperty("interestBNBBurn") var interestBNBBurn:Boolean?=null)
{
}