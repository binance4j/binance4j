...
data class Transaction(
		...
		@ApiModelProperty("Tokens.") List<NFT> tokens, @ApiModelProperty("Trade time in ms.") @JsonProperty("tradeTime ") var tradeTime : Long = 0L,
		@ApiModelProperty("Trade amount.") @JsonProperty("tradeAmount ") var tradeAmount : String = "",
		@ApiModelProperty("Currency used to buy the NFT.") @JsonProperty("tradeCurrency ") var tradeCurrency : String = "") {
}
