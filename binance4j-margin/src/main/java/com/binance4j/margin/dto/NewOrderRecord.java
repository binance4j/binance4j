...
public record NewOrderRecord(@ApiModelProperty("Order id.") long orderId,
		@ApiModelProperty("Traded symbol.") String symbol,
		@ApiModelProperty("Order side.") OrderSide side, @ApiModelProperty("Order status.") String status,
		@ApiModelProperty("Order type.") String type,
		@ApiModelProperty("Order time in force.") String timeInForce,
		@ApiModelProperty("Transaction time.") long transactTime,
		@ApiModelProperty("Client order id.") String clientOrderId, @ApiModelProperty("Symbol price.") String price,
		@ApiModelProperty("Order original quantity.") String origQty,
		@ApiModelProperty("Order executed quantity.") String executedQty,
		...
		@ApiModelProperty("Filled trades.") List<Trade> fills) {
}