...
public record IsolatedTierData(@ApiModelProperty("Related symbol.") String symbol, @ApiModelProperty("Tier.") int tier,
		@ApiModelProperty("Effective multiple.") String effectiveMultiple, @ApiModelProperty("Initial risk ratio.") String initialRiskRatio,
		@ApiModelProperty("Liquidation risk ratio.") String liquidationRiskRatio, @ApiModelProperty("Base asset max borrowable.") String baseAssetMaxBorrowable,
