...
public record NewOCOOrderRecord(@ApiModelProperty("Order list id.") long orderListId, @ApiModelProperty("Contingency type.") String contingencyType,
		...
		@ApiModelProperty("Is the order isolated?") boolean isIsolated, @ApiModelProperty("The 2 orders.") List<MiniOrderInfo> orders,
