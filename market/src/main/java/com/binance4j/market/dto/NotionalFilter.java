 ...
 * 
 * @param maxNotional      Minimum notional value allowed for an order on a
 *                         symbol. An order's notional value is the.
 *                         price * quantity.
 * @param applyMinToMarket Maximum notional value allowed for an order on a
 *                         symbol. An order's notional value is the.
 *                         price * quantity.
 * @param applyMaxToMarket Determines whether the minNotional will be applied to
 *                         MARKET orders.
 * @param avgPriceMins     determines whether the maxNotional will be applied to
 *                         MARKET orders.
 * @param minNotional      Number of minutes the average price is calculated
