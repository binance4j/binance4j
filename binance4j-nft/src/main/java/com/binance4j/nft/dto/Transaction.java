 ...
 * NFT transaction.
 * 
 * @param orderNo       Order number. 0: purchase order 1: sell order 2: royalty
...
public record Transaction(
		...
		@ApiModelProperty("Trade amount.") String tradeAmount,
		@ApiModelProperty("Currency used to buy the NFT.") String tradeCurrency) {
}
