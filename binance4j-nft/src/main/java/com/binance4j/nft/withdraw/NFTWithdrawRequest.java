...
public class NFTWithdrawRequest extends IntervalRequest {
     ...
     */
    public NFTWithdrawRequest(int limit, int page) {
        this();
        this.limit = limit;
        this.page = page;
    }
     ...
     */
    public NFTWithdrawRequest(int limit, int page, long startTime, long endTime) {
        this(limit, page);
