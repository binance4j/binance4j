...
public class WebsocketMiniDepthClient extends BaseWebsocketClient<MiniDepthPayload> {
	 ...
	 */
	public WebsocketMiniDepthClient(String symbols, DepthLevel level, DepthUpdateSpeed speed, WebsocketCallback<MiniDepthPayload> callback) {
		super(symbols, String.format("depth%s@%s", level.getLevel(), speed.getSpeed()), MiniDepthPayload.class, callback);
	}
