...
public enum ApiErrorCode {
	 ...
	 * <li>Too much request weight used; current limit is %s request weight per %s %s. Please use the websocket for live
	 * updates to avoid polling the API.</li>
	 * <li>Way too much request weight used; IP banned until %s. Please use the websocket for live updates to avoid
	 * bans.</li>
	 * </ul>
	 */
	 ...
	 * <li>Not all sent parameters were read; read %s parameter(s) but was sent %s.
	 * </ul>
	 */
	...
	/**
	 * The residual balances have exceeded 0.001BTC, Please re-choose. The residual balances of %s have exceeded 0.001BTC,
	 * Please re-choose.
	 */
	 ...
	 * asset, and the sum of the quantity of all open BUYorders.
	 */
	MAX_POSITION(-9007),
