...
public record OrderReport(@ApiModelProperty("The order list id.") long orderListId,
		@ApiModelProperty("The original client order id.") String origClientOrderId,
		@ApiModelProperty("The order timestamp.") long transactTime,
		@ApiModelProperty("The order side.") OrderSide side,
