	...
	public SymbolFilters deserialize(JsonParser jp, DeserializationContext ctx) throws IOException {
		...
		node.forEach(n -> {
			...
			case "ICEBERG_PARTS":
				...
				break;
			case "LOT_SIZE":
				filters.setLotSize(new LotSizeFilter(new BigDecimal(n.get("minQty").asText()), new BigDecimal(n.get("maxQty").asText()),
						new BigDecimal(n.get("stepSize").asText())));
				break;
			case "MARKET_LOT_SIZE":
				filters.setMarketLotSize(new MarketLotSizeFilter(new BigDecimal(n.get("minQty").asText()), new BigDecimal(n.get("maxQty").asText()),
						new BigDecimal(n.get("stepSize").asText())));
				break;
			case "MAX_NUM_ALGO_ORDERS":
				filters.setMaxNumAlgoOrders(new MaxNumAlgoOrdersFilter(new BigDecimal(n.get("maxNumAlgoOrders").asText())));
				break;
			...
			case "MAX_POSITION":
				...
				break;
			case "MIN_NOTIONAL":
				filters.setMinNotional(new MinNotionalFilter(new BigDecimal(n.get("minNotional").asText()), n.get("applyToMarket").asBoolean(),
						n.get("avgPriceMins").asInt()));
				break;
			case "NOTIONAL":
				filters.setNotional(new NotionalFilter(new BigDecimal(n.get("minNotional").asText()), new BigDecimal(n.get("maxNotional").asText()),
						n.get("applyMinToMarket").asBoolean(), n.get("applyMaxToMarket").asBoolean(), n.get("avgPriceMins").asInt()));
				break;
			case "PERCENT_PRICE_BY_SIDE":
				filters.setPercentPriceBySide(new PercentPriceBySideFilter(new BigDecimal(n.get("bidMultiplierUp").asText()),
				...
				break;
			case "PERCENT_PRICE":
				filters.setPercentPrice(new PercentPriceFilter(new BigDecimal(n.get("multiplierUp").asText()), new BigDecimal(n.get("multiplierDown").asText()),
						new BigDecimal(n.get("avgPriceMins").asText())));
				break;
			case "PRICE_FILTER":
				filters.setPrice(new PriceFilter(new BigDecimal(n.get("minPrice").asText()), new BigDecimal(n.get("maxPrice").asText()),
						new BigDecimal(n.get("tickSize").asText())));
				break;
			case "TRAILING_DELTA":
				filters.setTrailingDelta(new TrailingDeltaFilter(new BigDecimal(n.get("minTrailingAboveDelta").asText()),
