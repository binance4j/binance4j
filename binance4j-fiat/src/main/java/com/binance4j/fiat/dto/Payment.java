 ...
 * @param price          Price.
 * @param status         Status: {@code Processing}, {@code Completed},
 *                       {@code Failed}, {@code Refunded}.
 * @param createTime     Create time in ms.
 * @param updateTime     Update time in ms.
 */
@ApiModel("A fiat payment.")
public record Payment(@ApiModelProperty("Order No.") String orderNo,
		@ApiModelProperty("Fiat trade amount.") String sourceAmount,
		@ApiModelProperty("Fiat token.") String fiatCurrency,
		@ApiModelProperty("Crypto trade amount.") String obtainAmount,
		@ApiModelProperty("Crypto token.") String cryptoCurrency, @ApiModelProperty("Trade fee.") String totalFee,
