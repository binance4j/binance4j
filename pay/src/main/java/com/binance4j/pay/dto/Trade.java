...
public record Trade(@ApiModelProperty("Transaction id.") String orderType,
		@ApiModelProperty("Transaction time in ms.") String transactionId,
		@ApiModelProperty("Transaction amount.") long transactionTime,
		@ApiModelProperty("Transaction asset.") String amount,
