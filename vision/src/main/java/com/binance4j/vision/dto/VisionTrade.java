 ...
 */
@ApiModel("A trade.")
public record VisionTrade(@ApiModelProperty("Trade id.") long tradeId, @ApiModelProperty("Time in ms.") long time,
		...
		@ApiModelProperty("Was it a buyer maker.") boolean isBuyerMaker,
		@ApiModelProperty("Was it the best price match?") boolean isBestMatch) {
	/**
