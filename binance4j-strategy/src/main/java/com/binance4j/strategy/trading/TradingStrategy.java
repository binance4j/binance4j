...
public interface TradingStrategy {
	 ...
	 * @return If the strategy sends a BUY signal
	 */
	boolean shouldEnter(List<Candle> bars, CandlestickInterval interval, int index);
	 ...
	 * @return If the strategy sends a BUY signal
	 */
	boolean shouldEnter(List<Candle> bars, CandlestickInterval interval);
	 ...
	 */
	boolean shouldExit(List<Candle> bars, CandlestickInterval interval, int index);
	 ...
	 * @return If the strategy sends a SELL signal
	 */
	boolean shouldExit(List<Candle> bars, CandlestickInterval interval);
	 ...
	 * @return The {@link BackTestResult} of the trading session
	 */
	BackTestResult backTest(List<Candle> bars, CandlestickInterval interval);
